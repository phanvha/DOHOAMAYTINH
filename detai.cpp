...
void draw_object()
{
	...
	//ranh gioi ga duong sat (hàng rào)
	glColor3f(0.647059,0.164706,0.164706);
	glBegin(GL_POLYGON);
	glVertex2f(0,250);
	glVertex2f(0,310);
...
int main(int argc,char** argv)
{
    ...
    printf("--------------------------------------------------------------------------------");
	printf("Nhan 'r' hoac 'R' de chuyen tin hieu den sang do. \n\n");
	printf("Nhan 'g' hoac 'G' de chuyen tin hieu den sang xanh. \n+\n");
    printf("Nhan 'd' hoac 'D' de chuyen sang ban ngay. \n\n");
	printf("Nhan 'n' hoac 'N' de chuyen sang ban dem. \n\n");
	printf("Nhan 't' hoac 'T' de tau chay vao ga.\n\n");
	printf("Su dung chuot phai de hien thi menu. \n\n");
	printf("Su dung chuot trai de thoat chuong trinh. \n\n\n");
	printf("Chon phim bat ky va nhan ENTER.\n");
	scanf("%s",&ch);
